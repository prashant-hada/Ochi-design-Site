...
function Navbar() {
  ...
  return (
    ...
    className='fixed z-[999] w-full px-14 py-5 flex justify-between items-center text-[#212121] bg-transparent bg-opacity-30 backdrop-blur-md shadow-sm'>
        ...
        <div className="links flex gap-10">
               {
                ["Services","Our Work","About Us","Insights","Contact Us"].map((item,index)=>(
                  <a key ={index} className={` text-md font-sans font-medium  ${index === 4 && "ml-32"}`} href="#">{item}</a>
                ))
               }
        </div> 
    </motion.div>
