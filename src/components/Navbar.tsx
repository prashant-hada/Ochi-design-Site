...
function Navbar() {
  ...
  return (
    ...
    className='fixed z-[999] w-full px-10 md:px-14 py-5 flex justify-between items-center text-[#212121] bg-transparent bg-opacity-30 backdrop-blur-md shadow-sm'>
        <div className="logo-div">
        <svg width="72" className="fill-[#212121]" height="30" viewBox="0 0 72 30" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <div className="links flex gap-10 ">
               {
                ["Services","Our Work","About Us","Insights","Contact Us"].map((item,index)=>(
                  <a key ={index} className={` text-md font-sans font-medium hidden md:inline-block  ${index === 4 && "ml-32"}`} href="#">{item}</a>
                ))
               }
        </div> 
    </motion.div>
